# -*- coding: utf-8 -*-
# turtlebot3_navi_my/launch/multi_goals4_nav2.launch.py
#
...
#
# 2. run
# $ ros2 launch turtlebot3_navi_my multi_goals4_nav2.launch.py
#
import os
...
def generate_launch_description():
    ...
    return LaunchDescription([
        ...
        Node(
            package='turtlebot3_navi_my',executable='multi_goals4_nav2',output="screen",
